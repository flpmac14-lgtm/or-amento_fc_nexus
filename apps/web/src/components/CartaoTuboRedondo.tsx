  ...
  return (
    <div className="rounded-xl border border-green-600/30 dark:border-cyan-500/30 bg-white dark:bg-slate-900/60 p-4">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="font-semibold text-stone-900 dark:text-white">Tubo redondo</h3>
      ...
      {!modoManual ? (
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          <label className="flex flex-col gap-1 text-xs sm:col-span-2">
            <span className="text-stone-600 dark:text-slate-400">Bitola (ex: Tubo 60.3 x 3.35 mm)</span>
            <input
              type="text"
            ...
            {designacao && !tuboEncontrado && (
              <span className="text-amber-700 dark:text-amber-400">não encontrado — informe o kg/m manualmente ou use o modo manual</span>
            )}
          </label>
          <label className="flex flex-col gap-1 text-xs">
            <span className="text-stone-600 dark:text-slate-400">Peso/m {tuboEncontrado && !kgMEditado ? "(catálogo)" : "(manual)"}</span>
            <div className="flex items-center gap-1">
              <input
                ...
                className={`w-full rounded-md border px-2 py-1.5 text-sm outline-none focus:border-green-600 dark:focus:border-cyan-500 ${
                  tuboEncontrado && !kgMEditado ? "border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-950 text-green-700 dark:text-cyan-300" : "border-stone-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-stone-900 dark:text-slate-100"
                }`}
              />
              {tuboEncontrado && (
                <button
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          <label className="flex flex-col gap-1 text-xs">
            <span className="text-stone-600 dark:text-slate-400">Diâmetro externo (mm)</span>
            <input
              type="text"
              inputMode="decimal"
          ...
          <label className="flex flex-col gap-1 text-xs">
            <span className="text-stone-600 dark:text-slate-400">Espessura da parede (mm)</span>
            <input
              type="text"
              inputMode="decimal"
          ...
          <label className="flex flex-col gap-1 text-xs">
            <span className="text-stone-600 dark:text-slate-400">Diâmetro interno (calculado)</span>
            <input
              type="text"
              readOnly
              ...
              className={`rounded-md border px-2 py-1.5 text-sm outline-none ${
                paredeInvalida ? "border-red-400 dark:border-red-500 bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300" : "border-stone-200 dark:border-slate-800 bg-stone-50 dark:bg-slate-950 text-green-700 dark:text-cyan-300"
              }`}
            />
          </label>
        </div>
      ...
      {modoManual && paredeInvalida && (
        <p className="mt-1 text-xs text-red-600 dark:text-red-400">A parede (2 × espessura) precisa ser menor que o diâmetro externo.</p>
      )}
