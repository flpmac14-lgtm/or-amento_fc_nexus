...
export default function Home() {
  ...
  // "Anexar desenho" — pedido explícito do usuário: só vincula o PDF ao
  // orçamento quando ele clica nesse botão (nunca automático ao extrair a
